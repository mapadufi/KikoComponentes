...
import com.kiko.kikocomponentes.components.appbars.MediumTopBarKiko
...
fun MediumTopBarScreen(
    ...
    LayoutBaseKiko(
        ...
        Column(
            ...
            Text(
                text = "A barra acima é o componente MediumTopBarKiko.",
...
@Preview(showBackground = true, showSystemUi = true, name = "MediumTopBar Screen Light")
@Composable
fun MediumTopBarScreenPreviewLight() {
...
@Preview(showBackground = true, showSystemUi = true, name = "MediumTopBar Screen Dark")
@Composable
fun MediumTopBarScreenPreviewDark() {
