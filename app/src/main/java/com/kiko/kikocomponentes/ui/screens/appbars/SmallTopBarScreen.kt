...
import com.kiko.kikocomponentes.components.appbars.SmallTopBarKiko
...
fun SmallTopBarScreen(
    ...
    LayoutBaseKiko(
        ...
        Column(
            ...
            Text(
                text = "A barra acima é o componente SmallTopBarKiko.",
...
@Preview(showBackground = true, showSystemUi = true, name = "SmallTopBar Screen Light")
@Composable
fun SmallTopBarScreenPreviewLight() {
...
@Preview(showBackground = true, showSystemUi = true, name = "SmallTopBar Screen Dark")
@Composable
fun SmallTopBarScreenPreviewDark() {
